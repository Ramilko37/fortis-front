...
const buildAssetIcons: BuildAssetIcon[] = [
  ...
  },
  {
    ...
    label: "РЛС",
    imageUrl: "/drone-defense/echelons/l2/radar-station.png",
    previewImageUrl: "/drone-defense/echelons/thumbs/radar-station.avif",
  },
  {
    groupId: "l2-optical",
    layerId: "layer_02_detection",
    label: "ОЭП",
    imageUrl: "/drone-defense/echelons/l2/optoelectronic-system.png",
    previewImageUrl: "/drone-defense/echelons/thumbs/optoelectronic-system.avif",
  },
  {
    groupId: "l2-thermal",
    layerId: "layer_02_detection",
  ...
  },
  {
    ...
    layerId: "layer_02_detection",
    label: "Акустика",
    imageUrl: "/drone-defense/echelons/l2/acoustic-array.png",
    previewImageUrl: "/drone-defense/echelons/thumbs/acoustic-array.avif",
  },
  {
    groupId: "l2-rf-passive",
    layerId: "layer_02_detection",
    label: "RF",
    imageUrl: "/drone-defense/echelons/l2/passive-rf-detector.png",
    previewImageUrl: "/drone-defense/echelons/thumbs/passive-rf-detector.avif",
  },
  {
  ...
  },
  {
    ...
    label: "GNSS",
    imageUrl: placeholderByLayer.layer_04_suppression,
    previewImageUrl: placeholderByLayer.layer_04_suppression,
    isPlaceholder: true,
  },
  {
    groupId: "l4-ew-radio",
  ...
  },
  {
    ...
    label: "МОГ",
    imageUrl: placeholderByLayer.layer_05_mid_range_kinetic,
    previewImageUrl: placeholderByLayer.layer_05_mid_range_kinetic,
    isPlaceholder: true,
  },
  {
    groupId: "l5-bars",
  ...
  },
  {
    ...
    label: "ЗРПК",
    imageUrl: placeholderByLayer.layer_06_last_line_kinetic,
    previewImageUrl: placeholderByLayer.layer_06_last_line_kinetic,
    isPlaceholder: true,
  },
  {
    groupId: "l6-pzrk",
  ...
  },
  {
    ...
    label: "Маск.",
    imageUrl: placeholderByLayer.layer_07_accuracy_disruption,
    previewImageUrl: placeholderByLayer.layer_07_accuracy_disruption,
    isPlaceholder: true,
  },
  {
    groupId: "l7-smoke",
  ...
  },
  {
    ...
    label: "Сетки",
    imageUrl: placeholderByLayer.layer_08_passive_protection,
    previewImageUrl: placeholderByLayer.layer_08_passive_protection,
    isPlaceholder: true,
  },
  {
  ...
  },
  {
    ...
    label: "Разнос",
    imageUrl: placeholderByLayer.layer_09_hardening,
    previewImageUrl: placeholderByLayer.layer_09_hardening,
    isPlaceholder: true,
  },
  {
    groupId: "l9-armoring",
